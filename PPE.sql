...
--
-- Hôte : localhost
-- Généré le : mar. 05 jan. 2021 à 08:35
...
--
-- AUTO_INCREMENT pour la table `owned`
--
ALTER TABLE `owned`
...
--
-- Contraintes pour la table `owned`
--
ALTER TABLE `owned`
